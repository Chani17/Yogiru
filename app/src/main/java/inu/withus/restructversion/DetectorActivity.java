...
import inu.withus.restructversion.customview.OverlayView.DrawCallback;
...
import inu.withus.restructversion.env.BorderedText;
        ...
        runInBackground(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        //=======================================================================//
                        //recognizeImage : YoloV4Classifier.java에서 객체 인식하는 함수
...
//                        }
                        ...
                        for(int i=0; i<results.size(); i++){
                            float obj_confidence = results.get(i).getConfidence();
                            //LOGGER.i("confidence is ())))))))))))))))) "+ obj_confidence);
                            if(obj_confidence > 0.75){
                                LOGGER.i("confidence : "+ obj_confidence);
                                Intent resultIntent = new Intent(DetectorActivity.this, RegisterFoodActivity.class);
                                LOGGER.i("title : "+ results.get(i).getTitle());
                                resultIntent.putExtra("foodName",  results.get(i).getTitle());
                                resultIntent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                                LOGGER.i("put complete");
